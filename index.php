...
if ($query) {
	...
	require_once('/Users/kamalnimmagadda/Desktop/Information Retrieval/HW4/solr-php-client/Apache/Solr/Service.php');

	// create a new solr service instance - host, port, and webapp
	// path (all defaults in this example)
	$solr = new Apache_Solr_Service('localhost', 8983, '/solr/example1');
...
<head>
	...
	<script>
		$(function() {
			var URL_PREFIX = "http://localhost:8983/solr/example1/suggest?q=";
...
<body>
	...
	?>
		...
		$csv = array_map('str_getcsv', file('/Users/kamalnimmagadda/Desktop/Information Retrieval/HW4/LATIMES/URLtoHTML_latimes_news.csv'));
		foreach ($results->response->docs as $doc) {
			...
			if ($url == "" || $url == null) {
				foreach ($csv as $row) {
					$cmp = "/Users/kamalnimmagadda/Desktop/Information Retrieval/HW4/LATIMES/latimes" + $row[0];
					if ($id == $cmp) {
						$url = $row[1];
						unset($row);
						break;
